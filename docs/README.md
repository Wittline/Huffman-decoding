...
![alt text](https://raw.githubusercontent.com/Wittline/Huffman-decompression/master/Resources/Proposal.JPG?token=AIWQRRU3BTK4QLHUY3MMETC5H4Y26)

## Code
You can see the code of the whole project here: <a href="https://github.com/Wittline/Huffman-decompression/tree/master/Code" target="_blank">Code</a>
